...
namespace DevIO.App.Controllers { 
    ...
    public class ProdutosController : BaseController
    {
        ...
        {
            var _produtoViewModel = _mapper.Map<IEnumerable<ProdutoViewModel>>(await _produtoRepository.ObterProdutosPorFornecedores());
        ...
        {
            //ViewData["FornecedorId"] = new SelectList(_produtoRepository.Set<FornecedorViewModel>(), "Id", "Documento");
        ...
        public async Task<IActionResult> Create(ProdutoViewModel produtoViewModel)
        {
            ...
            //ViewData["FornecedorId"] = new SelectList(_produtoRepository.Set<FornecedorViewModel>(), "Id", "Documento", produtoViewModel.FornecedorId);
        ...
        private async Task<bool> UploadArquivo(IFormFile imagemUpload, string imgPrefixo)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Já existe uma arquico com este nome!");
            }
